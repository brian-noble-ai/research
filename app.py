...
if not os.path.exists("component_df.pkl"):
    ...
    component_df.to_pickle("component_df.pkl")
    chem_db.to_pickle("chem_db.pkl")
    all_form_data.to_pickle("all_form_data.pkl")
else:
    component_df = pd.read_pickle("component_df.pkl")
    chem_db = pd.read_pickle("chem_db.pkl")
    all_form_data = pd.read_pickle("all_form_data.pkl")
